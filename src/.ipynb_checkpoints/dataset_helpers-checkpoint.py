...
def load_dataset(name, mri_type, center_crop=None, random_crop=None, filter=None, batch_size=32, cache=True, prefetch_buffer=512, shuffle_buffer=128, interleave=1, cast_to=tf.float32, clip_labels_to=0.0, take_only=None, shuffle=True, infinite=False, n_threads=os.cpu_count()):
    '''
...
if __name__ == '__main__':
    ...
    # Pipeline for preparing BRATS2015
    ...
    #pack_dataset(brats_train, 'brats2015-Train-all', dataset_suffix='scrapme', dataset_min=0,
    #             dataset_max=100, center_crop=center_crop, normalize_to='mri')


    # file_paths, dataset_name, dataset_suffix, dataset_min, dataset_max, center_crop=[180,180,128], normalize_to='mri', percentiles=[2, 98]
