...
def build_segmentor(mri_shape, seg_channels=1):
    ...
    dec3_f1 = S_dec_block(enc4, f=256, k=1, name='S_dec_3f1')
    dec3_f3 = S_dec_block(enc4, f=256, k=3, name='S_dec_3f3')
    dec3_f5 = S_dec_block(enc4, f=256, k=5, name='S_dec_3f5')
...
def build_critic(mri_shape, seg_shape):
    ...
    enc5_f1 = C_enc_block(enc4, f=1024, k=1, name='C_enc_5_f1')
    enc5_f3 = C_enc_block(enc4, f=1024, k=3, name='C_enc_5_f3')
    enc5_f5 = C_enc_block(enc4, f=1024, k=5, name='C_enc_5_f5')
    enc5 = layers.Add(name='C_enc_5')([enc5_f1, enc5_f3, enc5_f5])
    
    enc6_f1 = C_enc_block(enc5, f=2048, k=1, name='C_enc_6_f1')
    enc6_f3 = C_enc_block(enc5, f=2048, k=3, name='C_enc_6_f3')
    enc6_f5 = C_enc_block(enc5, f=2048, k=5, name='C_enc_6_f5')
    enc6 = layers.Add(name='C_enc_6')([enc6_f1, enc6_f3, enc6_f5])
    ...
    enc5fl = layers.Flatten()(enc5)
    enc6fl = layers.Flatten()(enc6)
    out = layers.Concatenate()([enc0fl, enc1fl, enc2fl, enc3fl, enc4fl, enc5fl, enc6fl])
