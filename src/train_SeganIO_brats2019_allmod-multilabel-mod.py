...
modelname = 'SegAnIO_brats2019_ALL_multilab_noshuffle_norandomcrop'
...
gan.load_dataset(dataset, input_modalities, training_shuffle=False, training_random_crop=False, training_center_crop=True)
